  ...
  return (
    <div className="w-full mx-auto flex flex-col items-center relative z-10">
      ...
      <div className="mb-2 text-center">
        ...
        <h1 className="text-7xl md:text-8xl tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white from-40% via-white via-60% to-red-600 drop-shadow-lg">
          PMF OR DIE
        </h1>
      ...
      <div className="w-full max-w-xl mx-auto">
        <p className="text-center text-base md:text-lg leading-relaxed text-gray-300 font-light mt-4">
          Al final el{" "}
          <span className="font-bold underline decoration-red-500">top 3</span>{" "}
